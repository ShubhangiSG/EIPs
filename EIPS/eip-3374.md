...
## Simple Summary
Set block reward to 3 and reduces it to 1 linearly over the course of about 1 year.

## Abstract
Set the block reward to 3 ETH and then incrementally decreases it every block for 2,362,000 blocks (approximately 1 year) until it reaches 1 ETH.
